...
class CustomSnackbarManager {
    ...
    private static CustomSnackbarManager sSnackbarManager;

    static CustomSnackbarManager getInstance() {
        if (sSnackbarManager == null) {
            sSnackbarManager = new CustomSnackbarManager();
        }
    ...
    public void show(int duration, Callback callback) {
        synchronized (mLock) {
            ...
            if (mCurrentSnackbar != null && cancelSnackbarLocked(mCurrentSnackbar,
                    CustomSnackbar.Callback.DISMISS_EVENT_CONSECUTIVE)) {
    ...
    private void scheduleTimeoutLocked(SnackbarRecord r) {
        if (r.duration == CustomSnackbar.LENGTH_INDEFINITE) {
        ...
        } else if (r.duration == CustomSnackbar.LENGTH_SHORT) {
