package com.linute.linute.UtilsAndHelpers.FiveStarRater;
...
public class FiveStarsDialog  implements DialogInterface.OnClickListener{
    ...
    private void build(){
        ...
        dialogView = inflater.inflate(R.layout.stars, null, false);
    ...
    private void sendEmail() {
        ...
        intent.putExtra(android.content.Intent.EXTRA_TEXT, "What can we do to make Tapt better?");
