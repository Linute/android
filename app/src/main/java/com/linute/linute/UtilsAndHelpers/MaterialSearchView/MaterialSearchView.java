package com.linute.linute.UtilsAndHelpers.MaterialSearchView;
...
import com.linute.linute.UtilsAndHelpers.MaterialSearchView.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private OnBackPressedListener mOnBackPressed;
    ...
    private final OnClickListener mOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == mBackBtn) {
                ...
                mSearchSrcTextView.getText().clear();
    ...
    public void setOnBackPressedListener(OnBackPressedListener lis){
        mOnBackPressed = lis;
    }
