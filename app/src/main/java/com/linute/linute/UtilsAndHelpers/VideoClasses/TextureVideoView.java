...
public class TextureVideoView extends TextureView
    ...
    TextureView.SurfaceTextureListener mSurfaceTextureListener = new SurfaceTextureListener() {
        ...
        public boolean onSurfaceTextureDestroyed(final SurfaceTexture surface) {
            ...
            if (mCustomSurfaceTextureListener != null){
                mCustomSurfaceTextureListener.onSurfaceDestroyed();
            }
    ...
    private CustomSurfaceTextureListener mCustomSurfaceTextureListener;

    public void setCustomSurfaceTextureListener(CustomSurfaceTextureListener lis){
        mCustomSurfaceTextureListener = lis;
    }

    public interface CustomSurfaceTextureListener{
