 ...
 */
public class PostCreateActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void postContent() {
        ...
        Uri image = ImageUtility.savePicture(this,  getBitmapFromView(mTextFrame));
        if (image != null) {
